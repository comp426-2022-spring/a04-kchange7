...
if (row === undefined) {
    ...
    const sqlInit = `
        CREATE TABLE accesslog ( remoteaddr TEXT, remoteuser BLOB, time INTEGER, method TEXT, url TEXT, protocol TEXT, httpversion TEXT, secure TEXT, status INTEGER, referer TEXT, useragent TEXT )
    `;
